...
import com.bukowiecki.regdebug.parsers.lldb.LLDBFloatingPointParser
...
class FloatingPointParserTest {
    ...
    @Test
    fun testParseLine1() {
        val result = LLDBFloatingPointParser.parseRegLine("xmm15 = {0xaf 0xca 0x6b 0x0c 0x3f 0x1d 0x25 0x2e 0xec 0x43 0xd4 0xd5 0xec 0x61 0x5c 0xc0}")
